class CountdownApp {
    ...
    showNotification(event) {
        ...
        const handleClose = () => {
            ...
            closeBtnElement.removeEventListener('click', handleCloseBtnClick);
            closeBtnElement.removeEventListener('touchend', handleCloseBtnClick);
            closeBtnElement.removeEventListener('touchstart', handleCloseBtnClick);
        ...
        const closeBtnElement = closeBtn;
        ...
        closeBtnElement.addEventListener('click', handleCloseBtnClick);
        closeBtnElement.addEventListener('touchend', handleCloseBtnClick);
        closeBtnElement.addEventListener('touchstart', handleCloseBtnClick);
        
        overlay.addEventListener('click', handleOverlayClick);
        overlay.addEventListener('touchend', handleOverlayTouch);
    }
            ...
            return `
                <div class="countdown-card type-${type} ${isExpired ? 'expired' : ''}">
                    <div class="countdown-header">
                        ...
                        <button class="delete-btn" onclick="app.deleteEvent(${event.id})">删除</button>
                    </div>
